...
data['character_version'] = '1.2.3'
print('character_version -> 1.2.3')
...
out_json_path = os.path.join(BASE, 'RealWorld_v1.2.3.card.json')
...
out_png_path = os.path.join(BASE, '..', 'RealWorld_v1.2.3.png')
