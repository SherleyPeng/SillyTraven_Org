...
data['character_version'] = '1.4.0'
print('character_version -> 1.4.0')
...
out_json_path = os.path.join(BASE, 'RealWorld_v1.4.0.card.json')
...
out_png_path = os.path.join(BASE, '..', 'RealWorld_v1.4.0.png')
