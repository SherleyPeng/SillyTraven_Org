...
data['character_version'] = '1.2.2'
print('character_version -> 1.2.2')
...
out_json_path = os.path.join(BASE, 'RealWorld_v1.2.2.card.json')
...
out_png_path = os.path.join(BASE, '..', 'RealWorld_v1.2.2.png')
