...
data['character_version'] = '1.7.5'
print('character_version -> 1.7.5')
...
out_json_path = os.path.join(BASE, 'RealWorld_v1.7.5.card.json')
...
out_png_path = os.path.join(BASE, '..', 'RealWorld_v1.7.5.png')
