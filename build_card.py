...
data['character_version'] = '1.7.7'
print('character_version -> 1.7.7')
...
out_json_path = os.path.join(BASE, 'RealWorld_v1.7.7.card.json')
...
out_png_path = os.path.join(BASE, '..', 'RealWorld_v1.7.7.png')
